...
exports.api_upload = function (app, argv) {
    ...
    app.post('/api/upload', cors(corsOptions), flUpload, function (req, res) {
...
exports.api_folder = function (app, argv) {
    ...
    app.post('/api/folder', cors(corsOptions), folderCreate, function (req, res) {
        ...
        if (typeof req.body.name == 'string') {
            ...
            if (clean_folder_name && clean_folder_name.length > 0 && fs.existsSync(full_path)) {
                ...
                res.setHeader('Content-Type', 'application/json');
                res.send(JSON.stringify({ code: 500, msg: 'already exists' }));
                return;
            }
