            ...
            req.files.fileBlob.forEach((el, indx) => {
                ...
                if (argv.crypt && code && code.length > 0) {
                    ...
                    if (fs.existsSync(target_file_path_crypt)) {
                        console.log(clp, 'File ' + target_file_path_crypt + ' is exist. It will be replace.');
                    ...
                    try{
                        ...
                        let clp = util.common_log_prefix(req);
                        console.log(clp, 'File ' + chalk.green(target_file_path_crypt) + ' was saved');
                        console.log(clp, 'Size: ' + chalk.green(util.humanFileSize(el.size)));
                        
                        
                    }catch(e){
                        let clp = util.common_log_prefix(req);
                        console.log(clp, 'Rename error2: ', e.toString());
