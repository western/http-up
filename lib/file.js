...
export class TFile {
    ...
    init() {
        try {
            ...
            this.isPreviewImg = ['jpg', 'jpeg', 'png', 'gif'].includes(this.ext);
            this.isPreviewDoc = ['txt', 'pdf', 'rtf', 'doc', 'docx', 'xls', 'xlsx', 'odt', 'ods'].includes(this.ext);

            this.isEditDoc = ['html', 'rtf', 'doc', 'docx', 'odt'].includes(this.ext);
            this.isEditCode = ['html', 'txt', 'js', 'css', 'md'].includes(this.ext);
            this.isEditMd = ['md'].includes(this.ext);
