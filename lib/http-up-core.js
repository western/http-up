        ...
        files.forEach((file) => {
            ...
            if (stats.isDirectory()) {
                file_list1.push(`
                    ...
                    <a href="` + req_path + file + `" class="list-group-item list-group-item-action fold">
                ...
                file_list2.push(`
                    ...
                    <a href="` + req_path + file + `" class="list-group-item list-group-item-action file">
                        <div class="d-flex w-100 justify-content-between">
            ...
            if (stats.isDirectory()) {
                file_list1.push(`
                    ...
                    <tr>
                      ...
                      <td ><i class="bi bi-folder"></i> <a class="nodecor" href="` + req_path + file + `">` + file + `</a></td>
                ...
                file_list2.push(`
                    ...
                    <tr>
                      ...
                      <td ><a class="nodecor" href="` + req_path + file + `">` + file + `</a></td>
            ...
            if (stats.isDirectory()) {
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        ...
                                        <!--a type="button" class="btn btn-sm btn-outline-secondary" href="` + req_path + file + `">View</a-->
				...
				*/
				...
				if (is_match) {
					...
					img_preview = `
    		            <div class="bd-placeholder-img card-img-top" width="100%" height="225" style="height:225px; background: no-repeat center/80% url('` + req_path + file + `'); background-size: cover;  " >
    		            </div>
    				`
