            ...
            basicAuth({
                ...
                unauthorizedResponse: function(req){
                    ...
                    if( !req.auth ){
                        ...
                        req_path = req_path.replace(/([^:]\/)\/+/g, '$1');

                        let clp = util.common_log_prefix(req);
                        console.log(clp, '403 Forbidden', colors.yellow(req_path));

                        return util.error_page_content('403', '403 Forbidden, auth required, wrong credentials');
                    }
