...
export const get_referer_or_path = (req) => {
    //console.log('get_referer_or_path req=', req);
    //console.log('get_referer_or_path req.headers.referer=', req.headers.referer);
    //console.log('get_referer_or_path req=', req);
    ...
    //let ret = urlencode.decode(url.parse(req.headers.referer).pathname);
